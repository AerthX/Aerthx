...
const HelpSupport = () => {
  ...
  <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <SectionHeading
      ...
      subtitle="Everything you need to know about AerthX, carbon credits, and EU CBAM compliance."
      icon={<FaQuestion />}
    />
    ...
    <div className="mt-12 space-y-4">
      {[
        {
          _id: 1,
          question: "What is EU CBAM and why does it matter for Indian exporters?",
          answer:
            "The Carbon Border Adjustment Mechanism (CBAM) is a European Union regulation requiring importers to report and eventually pay for the carbon emissions embedded in products such as steel, cement, aluminium, fertilizers, hydrogen, and electricity. AerthX helps businesses calculate emissions, prepare compliance-ready reports, and stay export-ready.",
        },
        {
          _id: 2,
          question: "What is a carbon credit?",
          answer:
            "A carbon credit represents one metric tonne of CO₂ reduced or removed from the atmosphere through certified climate projects. Businesses purchase carbon credits to offset unavoidable emissions and support verified sustainability initiatives.",
        },
        {
          _id: 3,
          question: "How does AerthX help my business?",
          answer:
            "AerthX helps you measure your carbon footprint, buy verified carbon credits, generate compliance reports, and track your sustainability journey through one easy-to-use platform.",
        },
        {
          _id: 4,
          question: "How do I know the carbon credits are genuine?",
          answer:
            "Every carbon credit on AerthX comes from internationally recognized registries such as Verra or Gold Standard. Each credit has a unique serial number that can be independently verified for complete transparency.",
        },
        {
          _id: 5,
          question: "How much does it cost to offset my carbon footprint?",
          answer:
            "The cost depends on your industry, emissions, and current market prices. AerthX provides a free carbon footprint calculator that estimates your emissions and the approximate cost of offsetting them.",
        },
        {
          _id: 6,
          question: "Will I receive a Carbon Offset Certificate?",
          answer:
            "Yes. Once your carbon credits are retired, AerthX generates a Carbon Offset Certificate containing project details, retirement information, and verification records for ESG reporting and compliance.",
        },
        {
          _id: 7,
          question: "Is AerthX available now?",
          answer:
            "AerthX is currently onboarding early users through a limited-access program. Join our waitlist to receive early access, product updates, and priority onboarding.",
        },
      ].map((faq, index) => (
        <AccordionItem
          key={faq._id}
