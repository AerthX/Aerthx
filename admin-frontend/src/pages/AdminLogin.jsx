...
export default function AdminLogin() {
  ...
  return <div className="min-h-screen flex items-center justify-center bg-slate-950 px-4">
    <form onSubmit={submit} className="w-full max-w-md rounded-2xl bg-white p-8 shadow-2xl">
      ...
      <button disabled={loading} className="mt-6 w-full rounded-lg bg-emerald-600 p-3 font-semibold text-white disabled:opacity-60">{loading ? "Signing in…" : "Admin Sign In"}</button>
    </form>
  </div>;
}
